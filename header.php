...
<body class="bg-white mx-auto">
            ...
            <div id="support-submenu" class="bg-white px-4 py-2 rounded-[10px]">
                <div class="flex flex-col space-y-2">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="terms.html" class="text-[#844D3E]">Terms and Conditions</a>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="return.html" class="text-[#844D3E]">Return and Refund Policy</a>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="shipping.html" class="text-[#844D3E]">Shipping Policy</a>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="warranty.html" class="text-[#844D3E]">Warranty Policy</a>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="condition.html" class="text-[#844D3E]">Warranty Conditions</a>
                    </div>
                </div>
            </div>
    ...
    <div id="submenu-box" class="w-full bg-[#EEE9E2] py-8 absolute top-20 left-0 hidden z-50 mt-2">
        <div class="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 px-6">
            ...
            <a href="terms.html" class="bg-white p-6 rounded-[20px] flex items-center space-x-4 hover:shadow-lg transition-shadow duration-300">
                <div class="bg-[#EEE9E2] p-4 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#844D3E">
                        <path d="M320-240h320v-80H320v80Zm0-160h320v-80H320v80ZM240-80q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h320l240 240v480q0 33-23.5 56.5T720-80H240Zm280-520v-200H240v640h480v-440H520ZM240-800v200-200 640-640Z"/>
                    </svg>
            ...
            <a href="return.html" class="bg-white p-6 rounded-[20px] flex items-center space-x-4 hover:shadow-lg transition-shadow duration-300">
                <div class="bg-[#EEE9E2] p-4 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#844D3E">
                        <path d="M280-80q-33 0-56.5-23.5T200-160q0-33 23.5-56.5T280-240q33 0 56.5 23.5T360-160q0 33-23.5 56.5T280-80Zm400 0q-33 0-56.5-23.5T600-160q0-33 23.5-56.5T680-240q33 0 56.5 23.5T760-160q0 33-23.5 56.5T680-80ZM246-720l96 200h280l110-200H246Zm-38-80h590q23 0 35 20.5t1 41.5L692-482q-11 20-29.5 31T622-440H324l-44 80h480v80H280q-45 0-68-39.5t-2-78.5l54-98-144-304H40v-80h130l38 80Zm134 280h280-280Z"/>
                    </svg>
            ...
            <a href="shipping.html" class="bg-white p-6 rounded-[20px] flex items-center space-x-4 hover:shadow-lg transition-shadow duration-300">
                <div class="bg-[#EEE9E2] p-4 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#844D3E">
                        <path d="M240-160q-50 0-85-35t-35-85H40v-440q0-33 23.5-56.5T120-800h560v160h120l120 160v200h-80q0 50-35 85t-85 35q-50 0-85-35t-35-85H360q0 50-35 85t-85 35Zm0-80q17 0 28.5-11.5T280-280q0-17-11.5-28.5T240-320q-17 0-28.5 11.5T200-280q0 17 11.5 28.5T240-240ZM120-360h32q17-18 39-29t49-11q27 0 49 11t39 29h272v-360H120v360Zm600 120q17 0 28.5-11.5T760-280q0-17-11.5-28.5T720-320q-17 0-28.5 11.5T680-280q0 17 11.5 28.5T720-240Zm-40-200h170l-90-120h-80v120ZM360-540Z"/>
                    </svg>
            ...
            <a href="warranty.html" class="bg-white p-6 rounded-[20px] flex items-center space-x-4 hover:shadow-lg transition-shadow duration-300">
                <div class="bg-[#EEE9E2] p-4 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#844D3E">
                        <path d="M320-480v-80h320v80H320Zm0-160v-80h320v80H320Zm-80 240h300q29 0 54 12.5t42 35.5l84 110v-558H240v400Zm0 240h442L573-303q-6-8-14.5-12.5T540-320H240v160Zm480 80H240q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h480q33 0 56.5 23.5T800-800v640q0 33-23.5 56.5T720-80Zm-480-80v-640 640Zm0-160v-80 80Z"/>
                    </svg>
            ...
            <a href="condition.html" class="bg-white p-6 rounded-[20px] flex items-center space-x-4 hover:shadow-lg transition-shadow duration-300">
                <div class="bg-[#EEE9E2] p-4 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#844D3E">
                        <path d="M80-720v-200h200v80H160v120H80Zm720 0v-120H680v-80h200v200h-80ZM80-40v-200h80v120h120v80H80Zm600 0v-80h120v-120h80v200H680ZM280-240h400v-480H280v480Zm0 80q-33 0-56.5-23.5T200-240v-480q0-33 23.5-56.5T280-800h400q33 0 56.5 23.5T760-720v480q0 33-23.5 56.5T680-160H280Zm80-400h240v-80H360v80Zm0 120h240v-80H360v80Zm0 120h240v-80H360v80Zm-80 80v-480 480Z"/>
                    </svg>
